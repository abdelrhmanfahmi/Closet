...
Route::get('HiAdmin' , 'manage@getAdminPage');
Route::post('HiAdmin' , 'manage@ValidateAdmin');

Route::get('/customers' , 'manage@getCustomersPage');
Route::get('/Brands' , 'manage@getBrandsPage');
Route::get('/Products' , 'manage@getProductsPage');
Route::get('/orders' , 'manage@getOrdersPage');
...
Route::post('/Brands' , 'manage@InsertBrand');
Route::get('/updateBrand/id={id}' , 'manage@getPageBrand');
Route::post('/updateBrand/id={id}' , 'manage@UpdateBrand');
Route::get('/deleteBrand/id={id}' , 'manage@DeleteBrand');
Route::get('/searchBrands/brand_name={brand}' , 'manage@searchBrand');
             /************************/
//Customer CRUD             
//Route::get('/customers/id={id}/access_key={apikey}' , 'manage@ShowDataCustomersById');
Route::get('/customers' , 'manage@ShowDataCustomers');
//Route::get('/customers' , 'manage@InsertCustomer');
Route::post('/customers' , 'manage@InsertCustomer');

Route::get('/getUpdateCustomer/{id}' , 'manage@GetUpdateCustomerPage');

Route::post('/getUpdateCustomer/{id}' , 'manage@UpdateCustomer');
//Route::get('/updatePageCustomer/id={id}' , 'manage@getUpdateCustomerPage');
Route::get('/deleteCustomer/{id}' , 'manage@DeleteCustomer');
//Route::get('/getSpecificAccount/username={username}/access_key={apikey}' , 'manage@getAccount');
//Route::get('/searchProductbyTag/subcategory_id={id}/access_key={apikey}','manage@searchByTags');
             /************************/    
//Product CRUD
